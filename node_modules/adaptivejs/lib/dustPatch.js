define(['dust-core', 'adaptivejs/utils', 'components-list', 'dustjs-component/helpers'], function(dust, Utils, components, componentHelperMixin) {
    ...
    dust = componentHelperMixin(dust);
    ...
    components.forEach(function(name, i) {
        dust.helpers[normalize(name)] = function(chunk, context, bodies, params) {
            ...
            if (name.indexOf('__') !== -1) {
                componentName = name.split('__')[0];
            }

            // Set the `is` param required by the `component` helper
            params.is = 'libs/stencil-' + componentName + '/' + name;
