define(['dust-core', 'adaptivejs/utils', 'components-list', 'dustjs-component/helpers'], function(dust, Utils, components, helperMixin) {

    dust = helperMixin(dust);

    console.log('helpers:', dust.helpers);
    ...
    components.forEach(function(name, i) {
        dust.helpers[normalize(name)] = function(chunk, context, bodies, params) {
            ...
            params.is = 'libs/stencil-' + name + '/' + name;
